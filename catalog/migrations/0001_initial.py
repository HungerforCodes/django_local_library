    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(help_text='13 Character <a href="http://www.isbn-international.org/content/what-isbn">ISBN number</a>', max_length=13, unique=True, verbose_name='ISBN')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('m', 'Maintenance'), ('o', 'On loan'), ('m', 'Available'), ('r', 'Reserved')], default='m', help_text='Book Availability', max_length=1)),
